...
<div class="intro">
  <section class="text-gray-600 body-font">
    <div class="container mx-auto flex px-7 py-14 md:flex-row flex-col items-center">
      <div class="lg:flex-grow md:w-1/2 lg:pr-14 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-sky-900">
          <Typewriter>
              ABOUT THE BLOG
          </Typewriter>
